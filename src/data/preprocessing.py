...
# stopwords are not removed for classification based on product titles according to findings of Yu, Product title classification versus text classification
# lowercase and ignoring punctuation is default
# stopwords can be turned on in sklearn as well
