...
def main(dataset_name, file_path):
    """ Runs data processing scripts to turn raw data from (../raw) into
        cleaned data ready to be analyzed (saved in ../processed).
    """
    dataset = load_dataset(dataset_name)
    df_additional = pd.read_csv(file_path, sep=';')
    store_dataset_for_language_modelling(dataset, dataset_name, df_additional)
...
def store_dataset_for_language_modelling(dataset, dataset_name, df_additional):
    logger = logging.getLogger(__name__)
    data_dir = os.environ['DATA_DIR']
    data_dir = Path(data_dir)

    for split in dataset:
        relative_path = 'data/processed/{}/language-modelling/{}_language_modelling_{}_additional_ds.txt'.format(dataset_name, split, dataset_name)
        file_path = data_dir.joinpath(relative_path)
        ...
        relative_path = 'data/processed/{}/language-modelling/{}_language_modelling_{}_with_category_as_sentence_additional_ds.txt'.format(dataset_name, split, dataset_name)
        file_path = data_dir.joinpath(relative_path)
        with open(file_path, 'w') as file:
    ...
    # logger.info('Dataset prepared for language modelling {}!'.format(dataset_name))
        ...
        relative_path = 'data/processed/{}/language-modelling/{}_language_modelling_{}_with_descriptions_additional_ds.txt'.format(
        ...
        relative_path = 'data/processed/{}/language-modelling/{}_language_modelling_{}_with_category_as_sentence_and_descriptions_additional_ds.txt'.format(
            dataset_name, split, dataset_name)
        file_path = data_dir.joinpath(relative_path)
        with open(file_path, 'w') as file:
